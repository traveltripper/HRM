...
Leavetype.create(name: "Bereavement", limit: 2)

Employee.create!(first_name: "admin", middle_name: "", last_name: "traveltripper", role_id: 4, department_id: 1, ttid: "ttadmin", email: "traveltripperhrmadmin@traveltripper.com", personal_email: "admin@tt.com", contact_no: "123456789", emergency_name: "test", emergency_contact_no: "123456789", designation: "Admin", actual_dob: DateTime.strptime('08/26/1990', '%m/%d/%Y'), certificate_dob: DateTime.strptime('08/26/1990', '%m/%d/%Y'), prev_years_of_exp: 5, pg: "test", graduation: "test", source_of_hire: "Direct", pancard_no: "12356", passport_no: "123456", status: "Active", date_of_joining: DateTime.strptime('09/14/2016', '%m/%d/%Y'), address: "test", password: "123456", password_confirmation: "123456")
Employee.create!(first_name: "hr", middle_name: "", last_name: "traveltripper", role_id: 3, department_id: 5, ttid: "tthr", email: "traveltripperhrmhr@traveltripper.com", personal_email: "admin@tt.com", contact_no: "123456789", emergency_name: "test", emergency_contact_no: "123456789", designation: "Admin", actual_dob: DateTime.strptime('08/26/1990', '%m/%d/%Y'), certificate_dob: DateTime.strptime('08/26/1990', '%m/%d/%Y'), prev_years_of_exp: 5, pg: "test", graduation: "test", source_of_hire: "Direct", pancard_no: "12356", passport_no: "123456", status: "Active", date_of_joining: DateTime.strptime('09/14/2016', '%m/%d/%Y'), address: "test", password: "123456", password_confirmation: "123456")
Employee.create!(first_name: "manager", middle_name: "", last_name: "traveltripper", role_id: 2, department_id: 5, ttid: "ttmr", email: "traveltripperhrmmr@traveltripper.com", personal_email: "admin@tt.com", contact_no: "123456789", emergency_name: "test", emergency_contact_no: "123456789", designation: "Admin", actual_dob: DateTime.strptime('08/26/1990', '%m/%d/%Y'), certificate_dob: DateTime.strptime('08/26/1990', '%m/%d/%Y'), prev_years_of_exp: 5, pg: "test", graduation: "test", source_of_hire: "Direct", pancard_no: "12356", passport_no: "123456", status: "Active", date_of_joining: DateTime.strptime('09/14/2016', '%m/%d/%Y'), address: "test", password: "123456", password_confirmation: "123456")
Employee.create!(first_name: "employee", middle_name: "", last_name: "traveltripper", role_id: 1, department_id: 2, ttid: "ttemp", email: "traveltripperhrmemp@traveltripper.com", personal_email: "admin@tt.com", contact_no: "123456789", emergency_name: "test", emergency_contact_no: "123456789", designation: "Admin", actual_dob: DateTime.strptime('08/26/1990', '%m/%d/%Y'), certificate_dob: DateTime.strptime('08/26/1990', '%m/%d/%Y'), prev_years_of_exp: 5, pg: "test", graduation: "test", source_of_hire: "Direct", pancard_no: "12356", passport_no: "123456", status: "Active", date_of_joining: DateTime.strptime('09/14/2016', '%m/%d/%Y'), address: "test", password: "123456", password_confirmation: "123456")
