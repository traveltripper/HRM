...
class NominationsControllerTest < ActionController::TestCase
  ...
  test "should create nomination" do
    assert_difference('Nomination.count') do
      post :create, nomination: { employee_id: @nomination.employee_id, name: @nomination.name, type: @nomination.type }
    end
  ...
  test "should update nomination" do
    patch :update, id: @nomination, nomination: { employee_id: @nomination.employee_id, name: @nomination.name, type: @nomination.type }
    assert_redirected_to nomination_path(assigns(:nomination))
  end
